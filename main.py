...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if '/start' in text:
        ...
        reply += '<a href="https://github.com/KrixtO1997">KrixtO1997 Github</a>\n'
        reply += '<a href="https://t.me/Krixt0">Krixt0 Telegram</a>'
    ...
    if '/up' in text:
        ...
        try:
            ...
            await bot.send_file(ev.chat,txtsendname,
                                ...
                                thumb='thumb.png',
                                buttons=[Button.url('📯 Krixt0','https://t.me/Krixt0')])
